...
class Ui_Save_images_dialog(object):
    def setupUi(self, Save_images_dialog):
        ...
        Save_images_dialog.setWindowModality(QtCore.Qt.NonModal)
        ...
        Save_images_dialog.setUnifiedTitleAndToolBarOnMac(False)
        self.centralwidget = QtWidgets.QWidget(Save_images_dialog)
        ...
        self.choose_directory_button = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.save_directory_label = QtWidgets.QLabel(self.centralwidget)
        ...
        self.progress_bar_all_frames = QtWidgets.QProgressBar(self.centralwidget)
        ...
        self.progress_bar_intra_frame = QtWidgets.QProgressBar(self.centralwidget)
        ...
        Save_images_dialog.setCentralWidget(self.centralwidget)
    ...
    def retranslateUi(self, Save_images_dialog):
        ...
        Save_images_dialog.setWindowTitle(_translate("Save_images_dialog", "ThermoGUI - Save Image"))
