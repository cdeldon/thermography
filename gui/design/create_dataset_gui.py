...
class Ui_CreateDataset_main_window(object):
    ...
    def retranslateUi(self, CreateDataset_main_window):
        ...
        self.module_working_button.setToolTip(_translate("CreateDataset_main_window", "Select current module as \'Working\' (shortcut: \'0\')"))
        ...
        self.module_broken_button.setToolTip(_translate("CreateDataset_main_window", "Select current module as \'Broken\' (shortcut: \'1\')"))
        ...
        self.label_4.setText(_translate("CreateDataset_main_window", "<html><head/><body><p><span style=\" font-weight:600;\">Total classified modules:</span></p></body></html>"))
        ...
        self.total_manual_classified_label.setText(_translate("CreateDataset_main_window", "<html><head/><body><p><span style=\" font-weight:600;\">0</span></p></body></html>"))
        self.total_automatic_classified_label.setText(_translate("CreateDataset_main_window", "<html><head/><body><p><span style=\" font-weight:600;\">0</span></p></body></html>"))
