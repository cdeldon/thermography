    ...
    def create(self):
        with tf.variable_scope(self.name):
            ...
            with tf.variable_scope('conv_1'):
                h_conv1_0 = conv_relu(x=self.x, kernel_shape=[3, 3, 1, 8], bias_shape=[8], name="_0")
            ...
            with tf.variable_scope('conv_3'):
                ...
                h_pool3 = max_pool_4x4(name="max_pool", x=h_conv3_0)
            ...
            with tf.variable_scope('full_connected_1'):
                ...
                W_fc1 = weight_variable(name="W", shape=[np.prod(current_shape) * 16, 256])
