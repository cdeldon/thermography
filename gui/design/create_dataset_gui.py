...
class Ui_CreateDataset_main_window(object):
    def setupUi(self, CreateDataset_main_window):
        ...
        CreateDataset_main_window.resize(971, 598)
        ...
        self.video_from_index = QtWidgets.QSpinBox(self.widget_3)
        ...
        self.from_video_index_label = QtWidgets.QLabel(self.widget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.to_video_index_label = QtWidgets.QLabel(self.widget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.video_to_index = QtWidgets.QSpinBox(self.widget_3)
        ...
        self.load_video_button = QtWidgets.QPushButton(self.widget_3)
        ...
        self.selected_output_path_label = QtWidgets.QLabel(self.widget_3)
        ...
        self.output_path_button = QtWidgets.QPushButton(self.widget_3)
        self.output_path_button.setObjectName("output_path_button")
        self.horizontalLayout_3.addWidget(self.output_path_button)
        self.save_module_dataset_button = QtWidgets.QPushButton(self.widget_3)
        ...
        self.play_video_button = QtWidgets.QPushButton(self.widget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.stop_video_button = QtWidgets.QPushButton(self.widget_3)
        ...
        self.current_module_view.setMinimumSize(QtCore.QSize(100, 100))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, CreateDataset_main_window):
        ...
        self.label.setText(_translate("CreateDataset_main_window", "<html><head/><body><p align=\"center\"><span style=\" font-weight:600;\">File</span></p></body></html>"))
        ...
        self.load_video_button.setText(_translate("CreateDataset_main_window", "Input Video"))
